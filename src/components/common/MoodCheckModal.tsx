...
export const MoodCheckModal = (props: MoodCheckModalProps) => {
  ...
  return <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-300 p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg animate-in zoom-in-95 duration-300">
        ...
        <div className="px-6 lg:px-8 pt-8 pb-6 border-b border-slate-200 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-t-3xl">
          <div className="text-center">
            ...
            <p className="text-sm lg:text-base text-slate-600">You're halfway through! Let's see how you're feeling.</p>
          </div>
        </div>
        ...
        <div className="px-6 lg:px-8 py-6">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              return <button key={mood.id} onClick={() => setSelectedMood(mood.id)} className={`relative p-4 rounded-xl border-2 transition-all active:scale-95 ${isSelected ? `bg-gradient-to-br ${mood.color} text-white border-transparent shadow-lg` : 'bg-white border-slate-200 hover:border-slate-300 text-slate-700'}`}>
                    <div className="text-center">
          ...
          {selectedMood && <div className="mb-6 p-4 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-xl animate-in slide-in-from-top duration-300">
