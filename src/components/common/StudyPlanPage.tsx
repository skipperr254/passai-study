...
const mockVerificationQuestions: QuizQuestion[] = [{
  ...
  correctAnswer: 0,
  explanation: 'World War II began in Europe on September 1, 1939, when Germany invaded Poland, leading Britain and France to declare war on Germany.',
  topic: 'World War II'
}, {
  id: '2',
  question: 'What were the main Allied powers in World War II?',
  options: ['Germany, Italy, Japan', 'USA, UK, Soviet Union, France, China', 'USA, Germany, UK', 'Soviet Union, Italy, Japan'],
  correctAnswer: 1,
  explanation: 'The main Allied powers were the United States, United Kingdom, Soviet Union, France, and China, who fought against the Axis powers.',
  topic: 'World War II'
}, {
  id: '3',
  question: 'What was the significance of D-Day?',
  options: ['The day Japan surrendered', 'The Allied invasion of Nazi-occupied France', 'The bombing of Pearl Harbor', 'The liberation of concentration camps'],
  correctAnswer: 1,
  explanation: 'D-Day (June 6, 1944) was the Allied invasion of Normandy, France, marking the beginning of the liberation of Western Europe from Nazi occupation.',
  topic: 'World War II'
}];
...
export const StudyPlanPage = ({
  ...
  return <div className="h-full overflow-y-auto pb-4">
      ...
      {showTaskModal && activeTask && activeTask.type !== 'flashcards' && activeTask.type !== 'quiz' && !showVerificationQuiz && <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-300" onClick={() => {
      setShowTaskModal(false);
      setActiveTask(null);
      setIsTimerRunning(false);
    }}>
